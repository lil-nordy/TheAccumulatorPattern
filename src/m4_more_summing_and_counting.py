...
def run_test_count_cosines_from():
    ...
    # Test 2
    expected = 2
    answer = count_cosines_from(4, 6, .25)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3
    expected = 2
    answer = count_cosines_from(5, 7, .5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4
    expected = 2
    answer = count_cosines_from(6, 8, .75)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5
    expected = 0
    answer = count_cosines_from(1, 30, 1)
...
def count_cosines_from(m, n, x):
    ...
    I forget how to add the or operator, so I'm going to go head and change the assignment to specify that the
    function should return the number of integers from m to n, inclusive, whose cosine is equal to or greater than x.
    Side effects:   None.
    Examples:
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 3.99  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 30)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 9.7876  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 10000)
...
def sum_unit_fractions_from(m, n):
    ...
    #   of the RANGE expression, if you happen to know them.
    # ------------------------------------------------------------------
    # Wow! That's super interesting. I created some  buggy code, and it worked for a specific test case: where m = 1,
    # n > m
    total = 0
    for i in range(n-m + 1):
        total += 1/(m + i)
    return total
    # # Buggy Code: Works for only a specific test case, doesn't return anything.
    # total = 0
    # for in in range(n-m + 1):
    #     totoal += 1/(i+1)
    #
# ----------------------------------------------------------------------
