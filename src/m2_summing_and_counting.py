...
def run_test_sum_more_cosines():
    ...
    print('Test 1 expected:', expected, '(or so)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.24831
    answer = sum_more_cosines(-2, 2)
    print('Test 3 expected:', expected, '(give or take)')
    print('       actual:  ', answer)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 2:
    expected = 6
    actual = count_sines_vs_cosines(5)
    print('Test 2 expected:', expected)
    print('       actual:', actual)

    # Test 3:
    expected = 5
    actual = count_sines_vs_cosines(4)
    print('Test 3 expected:', expected)
    print('       actual', actual)
    ...
    print('Test 5 expedted:', expected)
    print('       actual', actual)
